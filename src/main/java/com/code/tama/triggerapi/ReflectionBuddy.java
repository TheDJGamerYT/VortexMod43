...
public class ReflectionBuddy {
	...
	public static class DelegateBorderChangeListenerAccess {
		public static final Function<BorderChangeListener.DelegateBorderChangeListener, WorldBorder> worldBorder = getInstanceFieldGetter(
				BorderChangeListener.DelegateBorderChangeListener.class, "f_61864_");
	}

	public static class EndDragonFightAccess {
		public static final Function<EndDragonFight, Boolean> dragonKilled = getInstanceFieldGetter(
				EndDragonFight.class, "f_64068_");
	}

	public static class Entity {
		public static final Function<net.minecraft.world.entity.Entity, EntityDimensions> dimensions = getInstanceFieldGetter(
				net.minecraft.world.entity.Entity.class, "f_19815_");
	}

	public static class ImmutableRegistryAccessAccess {
		public static final MutableInstanceField<ImmutableRegistryAccess, Map<? extends ResourceKey<? extends Registry<?>>, ? extends Registry<?>>> registries = getInstanceField(
				ImmutableRegistryAccess.class, "f_206223_");
	}

	public static class LayeredRegistryAccessAccess {
		@SuppressWarnings("rawtypes")
		public static final Function<LayeredRegistryAccess, RegistryAccess.Frozen> composite = getInstanceFieldGetter(
				LayeredRegistryAccess.class, "f_244063_");

		@SuppressWarnings("rawtypes")
		public static final MutableInstanceField<LayeredRegistryAccess, List<RegistryAccess.Frozen>> values = getInstanceField(
				LayeredRegistryAccess.class, "f_244050_");
	}

	/** fields in MinecraftServer needed for registering dimensions */
	public static class MinecraftServerAccess {
		public static final Function<MinecraftServer, Executor> executor = getInstanceFieldGetter(MinecraftServer.class,
				"f_129738_");
		...
		public static final Function<MinecraftServer, ChunkProgressListenerFactory> progressListenerFactory = getInstanceFieldGetter(
				MinecraftServer.class, "f_129756_");
		public static final Function<MinecraftServer, LayeredRegistryAccess<RegistryLayer>> registries = getInstanceFieldGetter(
				MinecraftServer.class, "f_244176_");
		public static final Function<MinecraftServer, LevelStorageAccess> storageSource = getInstanceFieldGetter(
				MinecraftServer.class, "f_129744_");
	}

	public static class ModelPartAccess {
		public static final Function<ModelPart, List<ModelPart.Cube>> cubes = getInstanceFieldGetter(ModelPart.class,
				"f_104212_");
	}
	...
	public static class StructureTemplateAccess {
		public static final Function<StructureTemplate, List<StructureTemplate.Palette>> palettes = getInstanceFieldGetter(
				StructureTemplate.class, "f_74482_");
	}

	public static class WorldBorderAccess {
		public static final Function<WorldBorder, List<BorderChangeListener>> listeners = getInstanceFieldGetter(
				WorldBorder.class, "f_61905_");
	}
}
